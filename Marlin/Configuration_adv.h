...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY //Kbra
    ...
    #define POWER_LOSS_STATE     HIGH // State of pin indicating power loss //Kbra
    #define POWER_LOSS_PULLUP         // Set pullup / pulldown as appropriate for your sensor //Kbra
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN   10 // (mm) Length of filament to purge on resume //Kbra
